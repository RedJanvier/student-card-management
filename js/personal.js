...
const display_school = (s) => {
    let school;
    switch(s){
        case 'sci': school = 'science';
            break;
        case 'eng': school = 'engineering';
            break;
        case 'arch': school = 'architecture';
            break;
        case 'cs': school = 'computer science';
            break;
        default: school = 'school unkown';
    }
    return `${school}`;
}
...
const display_card = ({ firstname, lastname, reg_number, image, program, school, year, created_at })=> {
    const html = `
        <div class="student-card">
            <p class="image"> <img src=${image} alt="profile" /> </p>
            <div class="card-content">
                <p class="name"><b>Name:</b> ${firstname} ${lastname}</p>
                <p class="school"><b>School Name:</b> ${display_school(school)}</p>
                <p class="school"><b>Program:</b> ${display_program(program)}</p>
